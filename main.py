...
STOCK_API_KEY = "3UAU3SOWA9A20M7D"
NEWS_API_KEY: str = "8613d2c907424117a41157cdfd709883"
...
data_list = [value for (key, value) in data.items()]  # List comprehension (Because we need yesterday's data)
